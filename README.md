...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-moon-1917)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-moon-1917
```

A live public deployment of this template is available at [https://steep-moon-1917.templates.workers.dev](https://steep-moon-1917.templates.workers.dev)
